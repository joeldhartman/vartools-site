...
| `-drwfit` | Direct maximum-likelihood damped-random-walk / CAR(1) fit ([Kelly+ 2009](https://ui.adsabs.harvard.edu/abs/2009ApJ...698..895K/abstract); [MacLeod+ 2010](https://ui.adsabs.harvard.edu/abs/2010ApJ...721.1014M/abstract)) — tighter `tau` recovery than the SF-based fit; optional RTS smoother, light-curve correction, and model variable | [CLI](cli/statistics.md#-drwfit) | [Python](python/commands/statistics.md#drwfit-direct-drw-maximum-likelihood-fit) |
...
| `-runlength` | Run-length statistics about the median and the ±k·MAD band — longest run, number of runs, and mean run length for points above/below the median and outside the band; a robust serial-coherence descriptor | [CLI](cli/statistics.md#-runlength) | [Python](python/commands/statistics.md#runlength-run-length-statistics-about-the-median-and-mad) |
...
| `-unstitch` | Undo a previous `-stitch`, restoring the original magnitudes (USERLIB extension) | [CLI](cli/extensions.md#-unstitch) | [Python](python/commands/extensions.md#unstitch-undo-a-stitch) |
| `-structurefunction` | Ensemble structure function on lag bins ([Simonetti+ 1985](https://ui.adsabs.harvard.edu/abs/1985ApJ...296...46S/abstract); MAD form per [Hughes+ 1992](https://ui.adsabs.harvard.edu/abs/1992ApJ...396..469H/abstract) / [Schmidt+ 2010](https://ui.adsabs.harvard.edu/abs/2010ApJ...714.1194S/abstract)); optional DRW / OU fit ([Kelly+ 2009](https://ui.adsabs.harvard.edu/abs/2009ApJ...698..895K/abstract); [MacLeod+ 2010](https://ui.adsabs.harvard.edu/abs/2010ApJ...721.1014M/abstract)) | [CLI](cli/statistics.md#-structurefunction) | [Python](python/commands/statistics.md#structurefunction-ensemble-structure-function) |
